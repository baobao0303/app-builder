...
function addParent<T extends Node | Record<string, any>>(obj: T, parent?: Node | null): T {
...
export function parse(cssInput: string, options: ParserOptions = {}): Stylesheet {
  let css = cssInput;
  let lineno = 1;
  let column = 1;
